        ...
        {healthConnectSupported() ? (
          <>
            <div style={{ marginTop: 10, display: 'flex', alignItems: 'center', gap: 12 }}>
              <span style={{ font: '700 16px/1.2 "Barlow Condensed", sans-serif', letterSpacing: '0.04em', textTransform: 'uppercase', color: calories === 'connected' ? 'var(--cyan-text)' : 'var(--text-secondary)' }}>
